const taskInput = document.querySelector('#tarefaNova');
const taskButton = document.querySelector('#criarBotao');
...
function renderTasks() {
    ...
    tasks.forEach((task, index) => {
        ...
        taskItem.innerHTML = `
                ...
                <button data-index=${index}>
                    <img src="./logo/lixeira.svg" alt="Excluir">
                </button>
            `;
    ...
    taskContainer.innerHTML = `
            <img id="clipboard" src="./logo/Clipboard.svg" alt="">
            <div>
